...
function commentsvotePanel($author)
{
	...
	<a href="javascript:void(0);" onclick="votecomment( ' . $comment->comment_ID . ', -1 );" title="Vote -1"><img src="http://png-1.findicons.com/files/icons/2315/default_icon/16/arrow_down.png" alt="Vote -1" border="0" /></a>
	
	<a href="javascript:void(0);" onclick="votecomment( ' . $comment->comment_ID . ', 1 );" title="Vote +1"><img src="http://png-1.findicons.com/files/icons/2315/default_icon/16/arrow_up.png" alt="Vote +1" border="0" /></a>' . $author;

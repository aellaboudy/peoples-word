...
class WPUF_Dashboard {
    ...
    function post_listing( $post_type ) {
        ...
        <h2 class="page-head">
            <span class="colour"><?php printf( __( "%s %s's Dashboard", 'wpuf' ), $userdata->first_name, $userdata->last_name ); ?></span>
        </h2>
    ...
    function user_info() {
        ...
        if ( wpuf_get_option( 'show_user_bio', 'wpuf_dashboard', 'on' ) == 'on' ) {
            ...
            <div class="wpuf-author">
                <h3><?php _e( 'Author Info', 'wpuf' ); ?></h3> <a  href=<?php echo esc_url( home_url( 'profile/' ) ); ?> > Edit Profile </a>
                <div class="wpuf-author-inside odd">
                    ...
                    <div class="wpuf-author-body">
                        <p class="wpuf-user-name"><a href="<?php echo get_author_posts_url( $userdata->ID ); ?>"><?php printf( esc_attr__( '%s %s', 'wpuf' ), $userdata->first_name, $userdata->last_name ); ?></a></p>

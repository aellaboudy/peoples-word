...
class WPUF_Add_Post {
	...
	if ( isset( $_POST['address'])) {
		$_SESSION['address_tag'] = trim($_POST['address'], '\"');
                $_SESSION['address_tag'] = preg_replace('/ [0-9]/', ', $0' , $_SESSION['address_tag']);
        }
	...
	if ( isset ($_SESSION['address_tag']) ) {
		$tags = $_SESSION['address_tag'];
	}

...
<div id="item-header-content">
	<h2 class="pagetitle"><a href="<?php bp_forum_permalink(); ?>" title="<?php bp_forum_name(); ?>"><?php bp_forum_name(); ?></a></h2>
	<span class="highlight"><?php //bp_forum_type(); ?></span> <span class="activity"><?php printf( __( 'active %s', 'x2' ), '' ); //bp_get_forum_last_active() ); ?></span>

...
jQuery(document).ready(function(){
	jQuery('input[id="_x2_page_category_name1"]').bind('click', function(){
		var status = jQuery(this).is(':checked');
		jQuery('input[name="_x2_page_category_name[]"]').attr('checked', status);
	});
	
	jQuery('input[id="_x2_page_featured_posts_category1"]').bind('click', function(){
		var status = jQuery(this).is(':checked');
		jQuery('input[name="_x2_page_featured_posts_category[]"]').attr('checked', status);
	});
});

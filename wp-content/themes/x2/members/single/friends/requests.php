	...
	<ul id="friend-list" class="item-list" role="main">
		<?php while ( bp_members() ) : bp_the_member(); ?>
			...
			<li id="friendship-<?php bp_friend_friendship_id() ?>">
				...
				<div class="action">
					<a class="button accept" href="<?php bp_friend_accept_request_link() ?>"><?php _e( 'Accept', 'x2' ); ?></a> &nbsp;
					<a class="button reject" href="<?php bp_friend_reject_request_link() ?>"><?php _e( 'Reject', 'x2' ); ?></a>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'You have no pending friendship requests.', 'x2' ); ?></p>
	</div>

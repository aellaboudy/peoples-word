		...
		<?php while ( bp_message_threads() ) : bp_message_thread(); ?>
			<tr id="notice-<?php bp_message_notice_id() ?>" class="<?php bp_message_css_class(); ?>">
				...
				<td width="21%">
					...
					<span class="activity"><?php _e("Sent:", 'x2'); ?> <?php bp_message_notice_post_date() ?></span>
				</td>
				...
				<td width="10%">
					...
					<a class="button" href="<?php bp_message_notice_delete_link() ?>" class="confirm" title="<?php _e( "Delete Message", 'x2' ); ?>">x</a>
				</td>
			</tr>
		<?php endwhile; ?>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'Sorry, no notices were found.', 'x2' ); ?></p>
	</div>
